import Strybog from "./main.js";

let str = new Strybog(512)
console.log("Алгоритм Хэширования Стрибог (512 бит)")
    let  testString = [0x32,  0x31,  0x30,  0x39,  0x38,  0x37,  0x36,  0x35, 0x34,  0x33,  0x32,  0x31,  0x30,  0x39,  0x38,  0x37, 
    ...
    let reshash = [0x48, 0x6F, 0x64, 0xC1, 0x91, 0x78, 0x79, 0x41, 0x7F, 0xEF, 0x08, 0x2B, 0x33, 0x81, 0xA4, 0xE2, 0x11, 
    ...
    let hash = str.GetHash(testString);
    console.log("reshash:\n"+reshash)
    console.log("Предполагаемое значение:\n"+hash)
    if(toString(hash) == toString(reshash)){
        console.log("Найденный Хэш - корректный")
    }else{
        console.log("Найденный Хэш - некорректный")
    }